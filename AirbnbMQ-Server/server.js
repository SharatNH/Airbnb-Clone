...
cnn.on('ready', function(){
	...
	//change email
	cnn.queue('email_queue', function(req,res){
		req.subscribe(function(message, headers, deliveryInfo, m){
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			registeruser.changeemail(req,message, function(req,res){
				console.log("inside email_queue");
	...
	//auction
	cnn.queue('getAuctionsToStart', function(req,res){
		req.subscribe(function(message, headers, deliveryInfo, m){
			console.log("getAuctionsToStart");
			util.log(util.format( deliveryInfo.routingKey, message));
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			auction.getAuctionsToStart(message, function(req,res){
	...
	cnn.queue('auctionLogs', function(req,res){
		req.subscribe(function(message, headers, deliveryInfo, m){
			console.log("5");
			...
			util.log("Message: "+JSON.stringify(message));
			util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
			auction.auctionLogs(message, function(req,res){
				console.log("inside addToAuction");
				console.log("message:"+message);
				cnn.publish(m.replyTo, res, {
					contentType:'application/json',
...
cnn.on('ready', function () {
    ...
    console.log("listening on booking_queue");
    cnn.queue('booking_queue', function(q){
        q.subscribe(function(message, headers, deliveryInfo, m){
            console.log("in booking queue on function call");
            util.log(util.format( deliveryInfo.routingKey, message));
            util.log("Message: "+JSON.stringify(message));
            util.log("DeliveryInfo: "+JSON.stringify(deliveryInfo));
            guests.booking(message, function(err,res){
