...
exports.changeemail=function(req,msg,callback)
{
    ...
    try{
        ...
        var user_id=msg.user_id;
        console.log(msg.newemail);
        console.log(msg.user_id);

        var res={};

        var query1="select * from users where email='"+msg.newemail+"'";

        var query2="update users set email ='"+msg.newemail+"' where user_id='"+user_id+"'";
        console.log(query1);
        console.log(query2);
