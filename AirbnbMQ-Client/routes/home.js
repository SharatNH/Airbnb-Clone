...
function search(req,res)
{
    ...
    console.log(arr[0]);
    var search_json = {
        "page":"filterPage","user_id":req.session.userid,"activity":"searched for specific locationand time", "timestamp": new Date().toString()
    };
    ...
    var msg_payload = {"where": where, "checkin": checkin, "checkout": checkout, "guests":arr[0], "userlogs":search_json};
