...
exports.getuserprofile=function(req,res){
    ...
    try {
        ...
        userlogs={"page":"DashboardPage","user_id":req.session.userid,"activity":"getting user profile","timestamp":Date.now()};
...
exports.updateprofile=function(req,res){
    ...
    try {
        ...
        userlogs={"page":"DashboardPage","user_id":req.session.userid,"activity":"update user profile","timestamp":Date.now()};
        var msg_payload={
            "user_id":user_id,
            "fname":fname,
            "lname":lname,
