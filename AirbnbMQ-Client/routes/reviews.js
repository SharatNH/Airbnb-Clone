...
exports.getreviews=function (req,res) {
    ...
    try {
        ...
        userlogs={"page":"DashboardPage","user_id":req.session.userid,"activity":"fetch user reviews","timestamp":Date.now()};
...
exports.postuserreview=function(req,res)
{
    ...
    try {
        ...
        userlogs={"page":"DashboardPage","user_id":req.session.userid,"activity":"deletion of the user","timestamp":Date.now()};
        var review = {reviewContent:reviewContent,reviewsMedia:reviewsMedia,userlogs:userlogs};
...
exports.posthostreview=function (req,res) {
    ...
    try {
        ...
        userlogs={"page":"DashboardPage","user_id":req.session.userid,"activity":"Post host reviews","timestamp":Date.now()};
