...
app.controller('propertyController',function ($scope,$http,$window) {
    ...
    $scope.loadproperty=function(){
        ...
        $http({
            ...
            if(data.statusCode==200){
                ...
                $scope.stay=data.staydays;
                $scope.rent=data.property[0].price;
                $scope.stayrent=data.stayrent;
                $scope.total = data.total;
                $scope.checkin=data.checkin;
                $scope.checkout=data.checkout;
                $scope.guests=data.guests;
                $scope.desc=data.property[0].description;
            }
            else{
    ...
    $scope.submit=function(){
        ...
        // console.log(cnum.toString().length);
            ...
            $http({
                ...
                alert("in success function");
                if(data.statusCode=200){
                    alert("payment successful! request sent to host");
                    window.location.assign("/homepage");
